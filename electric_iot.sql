...
-- -----------------------------------------------------
-- Placeholder table for view `electric_iot`.`vie_get_device_last_location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electric_iot`.`vie_get_device_last_location` (`id` INT, `uid` INT, `imsi` INT, `name` INT, `serial_number` INT, `is_delete` INT, `type_id` INT, `type` INT, `status_id` INT, `status` INT, `user_id` INT, `user` INT, `department_id` INT, `department` INT, `comment` INT, `create_time` INT, `keep_live_interval` INT, `battery_sleep_time` INT, `battery_keep_live_time` INT);
...
-- -----------------------------------------------------
-- View `electric_iot`.`vie_get_device_last_location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `electric_iot`.`vie_get_device_last_location`;
DROP VIEW IF EXISTS `electric_iot`.`vie_get_device_last_location` ;
USE `electric_iot`;
CREATE  OR REPLACE VIEW `vie_get_device_last_location` AS
SELECT
	`device`.`id` AS `id`,
	`device`.`uid` AS `uid`,
	`device`.`imsi` AS `imsi`,
