...
CREATE TABLE IF NOT EXISTS `electric_iot`.`device_location` (
  ...
  `nation1_num` INT NULL COMMENT '设备的AGPS国家号',
  `mobile1_num` INT NULL COMMENT '设备的AGPS移动网络号',
  `location1_num` INT NULL COMMENT '设备的AGPS位置区域号',
  `community1_num` INT NULL COMMENT '设备的AGPS小区号',
  `station1_flag` INT NULL COMMENT '设备的AGPS基站标识号',
  `signal1_strength` INT NULL COMMENT '设备的AGPS信号强度',
  `nation2_num` INT NULL,
  `mobile2_num` INT NULL,
  `location2_num` VARCHAR(45) NULL,
  `community2_num` VARCHAR(45) NULL,
  `station2_flag` VARCHAR(45) NULL,
  `signal2_strength` VARCHAR(45) NULL,
  `device_locationcol` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
