...
CREATE TABLE IF NOT EXISTS `electric_iot`.`device_cmd` (
  ...
  `set_gprs_send_interval` INT NULL COMMENT '当该位不为null是，表示需要设置设备的GPS发送间隔时间',
  `get_gprs_send_interval` TINYINT(1) NULL COMMENT '当该位不为null是，表示需要获取设备的GPS发送间隔时间',
