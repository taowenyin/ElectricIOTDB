...
CREATE TABLE IF NOT EXISTS `electric_iot`.`device` (
  ...
  `battery_send_gprs_interval` INT NOT NULL DEFAULT 180 COMMENT '电池供电时GPS发送间隔，默认180分钟',
  `power_send_gprs_interval` INT NOT NULL DEFAULT 5 COMMENT '电源供电时GPS发送间隔，默认5分钟',
