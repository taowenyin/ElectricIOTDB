...
-- -----------------------------------------------------
-- Placeholder table for view `electric_iot`.`bind_user_department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electric_iot`.`bind_user_department` (`id` INT, `department_id` INT, `department_name` INT, `level` INT, `department_create_time` INT, `department_is_delete` INT, `parent_id` INT, `user_id` INT, `login_name` INT, `login_password` INT, `user_name` INT, `user_create_time` INT, `mobile` INT, `email` INT, `user_is_delete` INT);

-- -----------------------------------------------------
-- View `electric_iot`.`bind_user_department`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `electric_iot`.`bind_user_department` ;
DROP TABLE IF EXISTS `electric_iot`.`bind_user_department`;
USE `electric_iot`;
CREATE  OR REPLACE VIEW `bind_user_department` AS
    SELECT 
